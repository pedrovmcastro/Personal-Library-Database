...
('Flores matinais colhidas ao entardecer', 'portuguese', 'chinese', TRUE, 1926, 1, 2021, 'chinese literature', 'chronicles', 'shelf', 1, 4, NULL);
...
-- FAZER OS TRIGGERS PARA LENDS = TRUE WHEN ADD SOMETHING IN BOOKS_ON_LEND
